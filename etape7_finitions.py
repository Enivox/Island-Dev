# -*- coding: utf-8 -*-
"""
ÉTAPE 7 — Finitions "look Apple" : ombre portée, noir profond, détails
======================================================================

  - MINI-ÎLE quand il y a de la musique (pochette + visualiseur animé).
    Survoler la mini-île déploie le grand panneau.
  - Grand panneau NOIR PROFOND avec OMBRE PORTÉE douce (effet "flottant"),
    timeline & volume dessinés à la main (capsule épaisse, façon Apple),
    boutons pleins arrondis, petit visualiseur en haut à droite, temps restant.
  - AUTO-MASQUAGE : pas de musique -> l'île disparaît ; musique -> elle revient.

NOTE : la fenêtre est un peu plus grande que le panneau visible, car il faut
de la place autour pour dessiner l'ombre (la marge est transparente).

Lancer :   python etape7_finitions.py
Quitter :  Ctrl + C (console) ou Échap.
"""
